...
def main():
    ...
    for sweep in range(1, total_sweeps + 1):
        ...
        if (sweep % 100 == 0):
            print(f'Sweep: {sweep}/{total_sweeps}')
    ...
    compute_autocorrelation(
        ...
        filename="./data/autocorr_potential_energy.png"
    )
    ...
    compute_autocorrelation(
        ...
        filename="./data/autocorr_exp_energy.png"
    )
    ...
    plot_block_averaging(
        ...
        filename="./data/block_avg_potential_energy.png"
    )
    ...
    plot_block_averaging(
        ...
        filename="./data/block_avg_exp_energy.png"
    )
    stop_time = time.time()
    run_time = (stop_time-starting_time)/60

    plt.figure(figsize=(8,5))
    plt.bar(["Surface Tension γ"], [gamma], yerr=[gamma_error], capsize=10, color='skyblue')
    plt.ylabel("Surface Tension γ")
    plt.title("Surface Tension with Uncertainty")
    plt.grid(axis='y')
    plt.savefig("./data/surface_tension_uncertainty.png")
    plt.close()
